namespace Web_cham_diem.Models
{
    public class Users
    {
        ...
        public ICollection<Competitions> CreatedCompetitions { get; set; } = new List<Competitions>();
        ...
        public ICollection<TeamMembers> TeamMemberships { get; set; } = new List<TeamMembers>();
